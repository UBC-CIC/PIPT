...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log(JSON.stringify({ level: "INFO", requestId, message: "Instructor authorization successful", userId: payload.sub }));
    return responseStruct;
  } catch (error) {
    console.error(JSON.stringify({ level: "ERROR", requestId, message: "Instructor authorization failed", error: error.message }));
